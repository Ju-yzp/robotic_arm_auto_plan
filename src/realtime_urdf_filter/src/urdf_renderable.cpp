...
{
    std::string model_file_path = "/home/llp/robotic_arm_auto_plan/src/realtime_urdf_filter/urdf/example.urdf";
    try {
...
void UrdfRenderable::processLink(const urdf::LinkSharedPtr &link)
{
    ...
    {
        RCLCPP_WARN(node_->get_logger(),"invaild geometry_type ");
    }
