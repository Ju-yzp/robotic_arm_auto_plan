...
int main(int argc,char **argv)
{
    ...
    std::string vertex_path = "/home/llp/robotic_arm_auto_plan/src/realtime_urdf_filter/shader/vertex.glsl";
    std::string fragment_path = "/home/llp/robotic_arm_auto_plan/src/realtime_urdf_filter/shader/fragment.glsl";
